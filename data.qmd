...
-   **Comma separated values formát** je ke stažení [zde](https://github.com/Sociology-FA-CU/uvod-do-r/raw/master/data/cvvm_cerven_2019.csv) (klikněte pravým tlačítkem a zvolte *Uložit odkaz jako...*/*Save link as...*).
